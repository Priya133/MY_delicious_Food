...
public partial class admin_add_health_tips : System.Web.UI.Page
{
    ...
    protected void loginbtn_submit_Click(object sender, EventArgs e)
    {
        ...
        FileUpload1.SaveAs(Server.MapPath("health/" + filename));
        int lik = 0;
        string str = ConfigurationManager.ConnectionStrings["db"].ConnectionString;
        conn = new SqlConnection(str);
        cmd = new SqlCommand("insert into health values(@h,@img,@dsc,@ddsc,@p)", conn);
