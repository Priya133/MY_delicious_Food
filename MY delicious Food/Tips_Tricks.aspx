<%@ Page Title="" Language="C#" MasterPageFile="~/other_pages.master" AutoEventWireup="true" CodeFile="Tips_Tricks.aspx.cs" Inherits="Tips_Tricks" %>
...
<table style="border: thick groove #C0C0C0;  color: #C0C0C0; font-size: medium; font-variant: normal; width:76% " >
  ...
  <tr>
    <td  style="border: medium solid #C0C0C0">
        ...
        <asp:Image ID="Image1" runat="server"  Height="250" Width="250" ImageUrl='<%# Bind("img", "~/tips/{0}") %>' />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [tips]"></asp:SqlDataSource>
</asp:Content>
